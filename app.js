...
//Pages Navigation
app.get("/", mainController.page('frontpage'));
app.get("/contact",mainController.page('contact'));
app.get("/workspace",mainController.page('workspace')); //old workspace for old elab
app.get("/cospace",mainController.page('cospace')); //020414 new working space for new elab
app.get("/developerinfo",mainController.page('developerinfo')); 
app.get("/groupinfo",mainController.page('groupinfo')); 
app.get("/cloudGoogleDrive",mainController.page('cloudGoogleDrive')); 
app.get("/cloudDropbox",mainController.page('cloudDropbox')); 
app.get("/mtp",mainController.page('mtp'));
app.get("/matthewApiTest",mainController.page('matthewApiTest'));
app.get("/dashboard",mainController.page('dashboard'));


app.get("/testlayout",mainController.page('layoutNiceAdmin'))

//****033114 Will be disable after workspace view is fully functioned*********
...
//************033114 Will be replaced by Google's push notification*******
